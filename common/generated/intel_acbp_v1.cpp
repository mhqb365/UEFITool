...
const std::set<intel_acbp_v1_t::ibb_segment_type_t> intel_acbp_v1_t::_values_ibb_segment_type_t{
    intel_acbp_v1_t::IBB_SEGMENT_TYPE_IBB,
    intel_acbp_v1_t::IBB_SEGMENT_TYPE_NON_IBB,
};
bool intel_acbp_v1_t::_is_defined_ibb_segment_type_t(intel_acbp_v1_t::ibb_segment_type_t v) {
    return intel_acbp_v1_t::_values_ibb_segment_type_t.find(v) != intel_acbp_v1_t::_values_ibb_segment_type_t.end();
}
const std::set<intel_acbp_v1_t::structure_ids_t> intel_acbp_v1_t::_values_structure_ids_t{
    intel_acbp_v1_t::STRUCTURE_IDS_PMDA,
    intel_acbp_v1_t::STRUCTURE_IDS_PMSG,
    intel_acbp_v1_t::STRUCTURE_IDS_ACBP,
    intel_acbp_v1_t::STRUCTURE_IDS_IBBS,
};
bool intel_acbp_v1_t::_is_defined_structure_ids_t(intel_acbp_v1_t::structure_ids_t v) {
    return intel_acbp_v1_t::_values_structure_ids_t.find(v) != intel_acbp_v1_t::_values_structure_ids_t.end();
}
...
void intel_acbp_v1_t::_read() {
    ...
    if (!(m_structure_id == intel_acbp_v1_t::STRUCTURE_IDS_ACBP)) {
        throw kaitai::validation_not_equal_error<intel_acbp_v1_t::structure_ids_t>(intel_acbp_v1_t::STRUCTURE_IDS_ACBP, m_structure_id, m__io, std::string("/seq/0"));
    }
...
void intel_acbp_v1_t::acbp_element_t::_read() {
    ...
    if ( ((header()->structure_id() != intel_acbp_v1_t::STRUCTURE_IDS_PMSG) && (header()->structure_id() != intel_acbp_v1_t::STRUCTURE_IDS_PMDA) && (header()->structure_id() != intel_acbp_v1_t::STRUCTURE_IDS_IBBS)) ) {
        ...
        {
            std::string _ = m_invalid_body;
            if (!(false)) {
                throw kaitai::validation_expr_error<std::string>(m_invalid_body, m__io, std::string("/types/acbp_element/seq/4"));
            }
        }
    }
}
